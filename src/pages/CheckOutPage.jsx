	...
	return (
		<section className="bg-white">
			<div className="container mx-auto">
				...
				{/* Forms  */}
				<div className="flex flex-col gap-8 py-10 xl:flex-row xl:items-start xl:gap-20">
					<div className="w-full max-w-full xl:max-w-md p-6">
						<h2 className="text-[36px] leading-7.5 tracking-[4%] font-medium mb-12">
							Billing Details
						</h2>
					...
					<div className="w-full max-w-full mt-8 xl:mt-0 xl:max-w-md bg-white p-6 rounded-lg ">
						{/* Products */}
						...
						{/* Subtotal */}
						<div className="flex justify-between text-sm mb-4 border-b border-black40 h-10">
							<p>Subtotal:</p>
							<p>$1750</p>
						</div>
						...
						<div className="flex gap-2 mb-4 flex-col sm:flex-row">
							...
							/>
							<button className="bg-secondary text-white px-4 py-2 rounded text-sm">
								Apply Coupon
							</button>
						</div>

						{/* Place Order */}
						<button className="bg-secondary text-white px-4 py-3 rounded text-sm font-medium">
							Place Order
						</button>
					</div>
				</div>
