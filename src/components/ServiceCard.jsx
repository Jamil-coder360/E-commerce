...
const ServiceCard = ({Icon, title, description}) => {
  return (
    <div className='text-center group'>
        ...
        <h3 className="text-[20px] font-semibold leading-7 pt-6 pb-2 text-black dark:text-white">{title}</h3>
        <p className=" text-[14px] leading-5.25 text-black dark:text-white">{description}</p>
    </div>
  )
}
